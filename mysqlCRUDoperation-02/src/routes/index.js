...
const userController = require('../controller/adminCtrl');
 ...
 * @returns {Error}  default - Unexpected error
 */
router.get('/admin', auth.verifyToken, userController.view);  // auth.verifyToken,
 ...
 * @returns {Error}  default - Unexpected error
 */
router.post('/admin/search', auth.verifyToken, userController.find); //tested
...
* @property {data} response data payload
*/
router.get('/admin/userInfo/:id', auth.verifyToken, userController.viewUser) //tested
 ...
 * @returns {Error}  default - Unexpected error
 */
router.get('/admin/adduser', auth.verifyToken, userController.addUserForm); //tested
 ...
 * @returns {Error} default - Unexpected error
 */
router.post('/admin/adduser', auth.verifyToken, userController.create); //tested
 ...
 * @returns {Error} default - Unexpected error
 */
router.get('/admin/edituser/:id', auth.verifyToken, userController.edit); //tested
 ...
 * @returns {Error} default - Unexpected error
 */
router.post('/admin/edituser/:id', auth.verifyToken, userController.update); //tested
 ...
 * @returns {Error} default - Unexpected error
 */
router.get('/admin/deleteuser/:id', auth.verifyToken, userController.delete); //tested
